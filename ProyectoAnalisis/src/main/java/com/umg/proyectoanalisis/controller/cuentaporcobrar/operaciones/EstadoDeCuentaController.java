...
public class EstadoDeCuentaController {
    ...
    public ResponseEntity<byte[]> generarPdf(
        ...
        try {
            ...
            document.add(new Paragraph("Grupo Charlie Bank")
                    .setBold()
                    .setFontSize(12)
                    .setTextAlignment(TextAlignment.CENTER));
            document.add(new Paragraph("Nombre del Cliente: Ernesto Arturo Quesada Pineda") 
                    .setFontSize(10));
            document.add(new Paragraph("Número de Cuenta: 101") 
                    .setFontSize(10));
    ...
    public ResponseEntity<byte[]> exportToExcel(
        ...
        try {
            ...
            LocalDateTime now = LocalDateTime.of(2025, 10, 1, 15, 42); 
            ...
            sheet.createRow(1).createCell(0).setCellValue("Nombre del Cliente: Ernesto Arturo Quesada Pineda");
            sheet.createRow(2).createCell(0).setCellValue("Número de Cuenta: 101");
            sheet.createRow(3).createCell(0).setCellValue("Fecha de Emisión: " + cstNow.format(java.time.format.DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss z")));
            sheet.createRow(4).createCell(0).setCellValue("Período: Desde " + anio + "-" + String.format("%02d", mes) + "-01 Hasta " + anio + "-" + String.format("%02d", mes) + "-30");
            ...
            headersN.setContentDispositionFormData("attachment", "estado_cuenta_" + cstNow.format(java.time.format.DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss")) + ".xlsx");
